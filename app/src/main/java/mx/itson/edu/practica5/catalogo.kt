...
class catalogo : AppCompatActivity()    {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var gridSeries: GridView = findViewById<GridView>(R.id.mseries_catalogo)
    ...
    class PeliculaAdapter : BaseAdapter{
        ...
        override fun getView(pe: Int, conterView: View?, p2: ViewGroup?): View {
...
//            vista.iv_peliculas.setImageResorce(pelicula.image)
//            vista.tv_titulos.setText(pelicula.titulo)
